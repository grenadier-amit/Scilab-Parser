...
"if (W<0 | W>100) then error(''Width must be between 0 and 100'');end";
	...
	scs_m_1.objs.push(scicos_link({xx: new ScilabDouble([80.105964],[97.43509],[97.43509]),yy: new ScilabDouble([235.384],[235.384],[212.76048]),thick: new ScilabDouble([0,0]),ct: new ScilabDouble([1,1]),from: new ScilabDouble([2,1,0]),to: new ScilabDouble([3,1,1])}));
	scs_m_1.objs.push(scicos_link({xx: new ScilabDouble([79.372631],[97.43509],[97.43509]),yy: new ScilabDouble([178.91733],[178.91733],[199.42714]),thick: new ScilabDouble([0,0]),ct: new ScilabDouble([1,1]),from: new ScilabDouble([1,1,0]),to: new ScilabDouble([3,2,1])}));
	...
	scs_m_1.objs.push(scicos_link({xx: new ScilabDouble([190.48879],[190.48879],[132.67318],[132.67318]),yy: new ScilabDouble([274.21741],[240.99048],[240.99048],[231.80809]),thick: new ScilabDouble([0,0]),ct: new ScilabDouble([5,-1]),from: new ScilabDouble([7,1,0]),to: new ScilabDouble([3,2,1])}));
	scs_m_1.objs.push(scicos_link({xx: new ScilabDouble([112.34974],[112.34974],[119.33985],[119.33985]),yy: new ScilabDouble([274.21741],[248.21372],[248.21372],[231.80809]),thick: new ScilabDouble([0,0]),ct: new ScilabDouble([5,-1]),from: new ScilabDouble([6,1,0]),to: new ScilabDouble([3,1,1])}));
	...
	scs_m_1.objs.push(scicos_link({xx: new ScilabDouble([154.57795],[174.57795]),yy: new ScilabDouble([206.09381],[206.09381]),thick: new ScilabDouble([0,0]),ct: new ScilabDouble([1,1]),from: new ScilabDouble([3,1,0]),to: new ScilabDouble([10,1,1])}));
